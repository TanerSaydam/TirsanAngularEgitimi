...
!(function (e) {
    ...
    (t = {
        ...
        getZoomPlaceholder: function () {
            ...
            return i ? ((e = i.substring(0, i.lastIndexOf("/"))), e.substring(0, e.lastIndexOf("/") + 1) + a) : a;
        },
        isBs: function (t) {
        ...
        (i.prototype = {
            ...
            _resetErrors: function (e) {
                ...
                t.isPersistentError ||
                    ...
                    ((t.clearInput = !1), (t.isError = !1), t.$container.removeClass("has-error"), t.$caption.removeClass("is-invalid is-valid file-processing"), i.html(""), e ? i.fadeOut("slow") : i.hide());
            },
                    ...
                    !i.length || t.hasClass("hide-rotate")
                        ...
                        : ((s = i.css("transform")),
                          ...
                          (90 !== o && 270 !== o) ||
                              ...
                              v.length && ((u = v.height()), (f = v.width()), (c = Math.min(d, f)), u > m * c && (m = c > u && 0 != c ? (u / c).toFixed(2) : 1)),
                              1 !== m && (g = " scale(" + m + ")")),
            ...
            _generatePreviewTemplate: function (i, a, r, n, o, s, l, d, c, u, f, p, g, m, h) {
                var v,
                    ...
                    M = $ ? "other" : i;
                return (
                    (b = 400 > I ? y.previewSettingsSmall[M] || y.defaults.previewSettingsSmall[M] : y.previewSettings[M] || y.defaults.previewSettings[M]),
                    b &&
                    ...
                    (_ = function (a, l, d, c, f) {
                        ...
                        return (
                            ...
                            t.isEmpty(m) || (void 0 !== m.title && null !== m.title && (E = m.title), void 0 !== m.alt && null !== m.alt && (A = E = m.alt)),
                            (h = {
                                previewId: v,
                                caption: T,
                                title: E,
                    ...
                    (x = y.fileActionSettings.showRotate && -1 !== e.inArray(S, y.rotatableFileExtensions)),
                    y.fileActionSettings.showZoom && ((C = "kv-zoom-thumb"), x && (C += " rotatable" + (U ? " hide-rotate" : "")), (P = _(U ? "other" : i, a, !0, C, h))),
                    (P = "\n" + y._getLayoutTemplate("zoomCache").replace("{zoomContent}", P)),
                    "function" == typeof y.sanitizeZoomCache && (P = y.sanitizeZoomCache(P)),
                    (C = "kv-preview-thumb"),
                    x && ((w = $ || y.hideThumbnailContent || !!y.previewFileIconSettings[S]), (C += " rotatable" + (w ? " hide-rotate" : ""))),
                    (v = _($ ? "other" : i, a, !1, C, h)),
    ...
    (e.fn.fileinput.defaults = {
        ...
        resumableUploadOptions: { fallback: null, testUrl: null, chunkSize: 2048, maxThreads: 4, maxRetries: 3, showErrorLog: !0, retainErrorHistory: !1, skipErrorsAndProceed: !1 },
        uploadExtraData: {},
        zoomModalHeight: 485,
        minImageWidth: null,
        minImageHeight: null,
